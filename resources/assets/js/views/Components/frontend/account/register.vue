                    ...
                    <div class="col-xs-12 col-sm-6">
                        ...
                        <form role="form" class="regForm">
                            <div class="form-group">
                                ...
                                <input title="Please enter your username (at least 3 characters)" type="text" class="form-control" placeholder="Enter name" required minlength="3" name="name">
                            </div>
                            <div class="form-group">
                                <label>Email address</label>
                                <input title="Please enter valid email" type="email" class="form-control" placeholder="Enter email" required name="email" id="email">
                            </div>
                            <div class="form-group">
                                <label>Password</label>
                                <input required minlength="5"
                            ...
                            <div class="form-group">
                                ...
                                <input required minlength="5"
                                       title="Please enter your password, between 5 and 12 characters" type="password"
                                       class="form-control" placeholder="Password" name="password_confirmation" id="password_confirmation">
                            </div>
                            <div class="error">
                            </div>

                            <button type="submit" class="btn btn-primary" v-on:click.prevent="register"><i class="fa fa-user"></i> Create an account
                            </button>
                        </form>
                    </div>
                </div>
    ...
    export default {
        ...
        methods: {
            register() {
                this.isProcessing = true
                this.error = {}
                axios.post('/api/account/register', this.credential)
                    .then((res) => {
                    console.log(res);
                    if(res.data.registered) {
                    Flash.setSuccess('Congratulations! You have now successfully registered.')
