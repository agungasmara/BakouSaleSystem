	...
	export default{
		...
		data(){
			return{
				...
				btnNewUrl:'/admin/attributes_group/add',
				listTitle:'Attributes List',
				headers: [
			        { text: 'Group ID',align: 'left',class:'text-xs-left',value: 'attribute_group_id'},
			        { text: 'Group',align:'left',class:'text-xs-left', value: 'name' },
			        { text: 'Language',align:'left',class:'text-xs-left', value: 'language' },
			        { text: 'Sort Order',align:'left',class:'text-xs-left', value: 'sort_order' },
			        {text: 'Action',align:'center',class:'text-xs-center',value:'attribute_group_id',status:'status',sortable: false}
			    ],
				attribute:[],
