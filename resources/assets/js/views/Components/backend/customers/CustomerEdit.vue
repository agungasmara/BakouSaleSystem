                ...
                <div class="row container">
                  <div class="container">
                    ...
                    <div class="col s2 m6 l6">
                        ...
                        <v-btn @click="submit(id)" :disabled="!valid" color="primary" class="btn dropdown-settings breadcrumbs-btn right">Save</v-btn>
                    </div>
                  </div>
                </div>
            </div>
...
<script>
    ...
    export default{
        ...
        methods:{
            fetchData(){
                console.log(this.id)
                axios.get(this.url+this.id+'/edit').then(res=>{
                    this.data.general=res.data.general
                    this.data.addressItem=res.data.general.addressItem
