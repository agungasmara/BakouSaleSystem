<template>
  <div>
    ...
    <li v-for="post of posts">
        <p>{{post.name}}</p>
        <div v-for="child of post['children']">
            <div>====> {{child.name}}</div>
        </div>
    </li>
                ...
                <div class="cartMenu  col-lg-4 col-xs-12 col-md-4 ">
                    <div class="w100 miniCartTable scroll-pane">
                        <table>
                            ...
                            <tr class="miniCartProduct">
                                <td style="width:20%" class="miniCartProductThumb">
                                    <div><a href="product-details.html"> <img src="/assets/frontend/images/product/2.jpg" alt="img"> </a>
                                    </div>
                                </td>
                                <td style="width:40%">
                                    <div class="miniCartDescription">
                            ...
                            <tr class="miniCartProduct">
                                <td style="width:20%" class="miniCartProductThumb">
                                    <div><a href="product-details.html"> <img src="/assets/frontend/images/product/5.jpg" alt="img"> </a>
                                    </div>
                                </td>
                                <td style="width:40%">
                                    <div class="miniCartDescription">
                            ...
                            <tr class="miniCartProduct">
                                <td style="width:20%" class="miniCartProductThumb">
                                    <div><a href="product-details.html"> <img src="/assets/frontend/images/product/4.jpg" alt="img"> </a>
                                    </div>
                                </td>
                                <td style="width:40%">
                                    <div class="miniCartDescription">
                    ...
                    <div class="miniCartFooter  miniCartFooterInMobile text-right">
                        ...
                        <a class="btn btn-sm btn-danger" href="/cart"> <i class="fa fa-shopping-cart"> </i>Cart
                        </a> <a href="checkout-0.html"
                                class="btn btn-sm btn-primary"> Check Out </a></div>
                    <!--/.miniCartFooter-->
                        ...
                        <ul class="dropdown-menu">
                            <li class="megamenu-content ">
                                <ul class="col-lg-3  col-sm-3 col-md-3 unstyled noMarginLeft newCollectionUl">
                                    ...
                                    <li><a href="/product/category"> ALL NEW PRODUCTS </a></li>
                                    <li><a href="/product/category"> NEW TOPS </a></li>
                                    <li><a href="/product/category"> NEW SHOES </a></li>
                                    <li><a href="/product/category"> NEW TSHIRT </a></li>
                                    <li><a href="/product/category"> NEW TSHOP </a></li>
                                </ul>
                                <ul class="col-lg-3  col-sm-3 col-md-3  col-xs-4">
                                    <li><a class="newProductMenuBlock" href="product-details.html"> <img
                                            class="img-responsive" src="/assets/frontend/images/site/promo1.jpg" alt="product"> <span
                                            class="ProductMenuCaption"> <i class="fa fa-caret-right"> </i> JEANS </span>
                                    </a></li>
                                </ul>
                                <ul class="col-lg-3  col-sm-3 col-md-3 col-xs-4">
                                    <li><a class="newProductMenuBlock" href="product-details.html"> <img
                                            class="img-responsive" src="/assets/frontend/images/site/promo2.jpg" alt="product"> <span
                                            class="ProductMenuCaption"> <i
                                            class="fa fa-caret-right"> </i> PARTY DRESS </span> </a></li>
                                </ul>
                                <ul class="col-lg-3  col-sm-3 col-md-3 col-xs-4">
                                    <li><a class="newProductMenuBlock" href="product-details.html"> <img
                                            class="img-responsive" src="/assets/frontend/images/site/promo3.jpg" alt="product"> <span
                        ...
                        <ul class="dropdown-menu">
                            <li class="megamenu-content">
                                ...
                                <ul class="col-lg-3  col-sm-3 col-md-3 col-xs-6">
                                    <li class="no-margin productPopItem "><a href="/product/detail"> <img
                                            class="img-responsive" src="/assets/frontend/images/site/g4.jpg" alt="img"> </a> <a
                                            class="text-center productInfo alpha90" href="/product/detail"> Eodem modo
                                        typi <br>
                                        <span> $60 </span> </a></li>
                                </ul>
                                <ul class="col-lg-3  col-sm-3 col-md-3 col-xs-6">
                                    <li class="no-margin productPopItem relative"><a href="/product/detail"> <img
                                            class="img-responsive" src="/assets/frontend/images/site/g5.jpg" alt="img"> </a> <a
                                            class="text-center productInfo alpha90" href="/product/detail"> Eodem modo
                                        typi <br>
                                        <span> $60 </span> </a></li>
                                </ul>
                        ...
                        <div class="dropdown-menu col-lg-4 col-xs-12 col-md-4 ">
                            <div class="w100 miniCartTable scroll-pane">
                                <table>
                                    ...
                                    <tr class="miniCartProduct">
                                        <td style="width:20%" class="miniCartProductThumb">
                                            <div><a href="product-details.html"> <img src="/assets/frontend/images/product/3.jpg" alt="img">
                                            </a></div>
                                        </td>
                                        <td style="width:40%">
                                            <div class="miniCartDescription">
                                    ...
                                    <tr class="miniCartProduct">
                                        <td style="width:20%" class="miniCartProductThumb">
                                            <div><a href="product-details.html"> <img src="/assets/frontend/images/product/2.jpg" alt="img">
                                            </a></div>
                                        </td>
                                        <td style="width:40%">
                                            <div class="miniCartDescription">
                                    ...
                                    <tr class="miniCartProduct">
                                        <td style="width:20%" class="miniCartProductThumb">
                                            <div><a href="product-details.html"> <img src="/assets/frontend/images/product/5.jpg" alt="img">
                                            </a></div>
                                        </td>
                                        <td style="width:40%">
                                            <div class="miniCartDescription">
                                    ...
                                    <tr class="miniCartProduct">
                                        <td style="width:20%" class="miniCartProductThumb">
                                            <div><a href="product-details.html"> <img src="/assets/frontend/images/product/4.jpg" alt="img">
                                            </a></div>
                                        </td>
                                        <td style="width:40%">
                                            <div class="miniCartDescription">
                                    ...
                                    <tr class="miniCartProduct">
                                        <td style="width:20%" class="miniCartProductThumb">
                                            <div><a href="product-details.html"> <img src="/assets/frontend/images/site/winter.jpg"
                                                                                      alt="img"> </a></div>
                                        </td>
                                        <td style="width:40%">
                                            <div class="miniCartDescription">
