...
<div class="container main-container headerOffset">
    ...
    <div class="row transitionfx">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
            ...
            <div class="main-image sp-wrap col-lg-12 no-padding">
                ...
                <a href="{{url('assets/frontend/images/product_details/hi-res-croped/1.jpg')}}"><img
                        src="{{url('assets/frontend/images/product_details/low-res-white/1.jpg')}}" class="img-responsive" alt="img"></a>
                <a href="{{url('assets/frontend/images/product_details/hi-res-croped/2.jpg')}}"><img
                        src="{{url('assets/frontend/images/product_details/low-res-white/2.jpg')}}" class="img-responsive" alt="img"></a>
                <a href="{{url('assets/frontend/images/product_details/hi-res-croped/3.jpg')}}"><img
                        src="{{url('assets/frontend/images/product_details/low-res-white/3.jpg')}}" class="img-responsive" alt="img"></a>
            </div>
        </div>
        <!--/ left column end -->
            ...
            <div class="productFilter productFilterLook2">
                <div class="row">
                    <div class="col-lg-6 col-sm-6 col-xs-6">
                        <div class="filterBox">
                            <select class="form-control">
                                <option value="strawberries" selected>{{trans('product/details/details.quantity')}}</option>
                    ...
                    <div class="col-lg-6 col-sm-6 col-xs-6">
                        <div class="filterBox">
                            <select class="form-control">
                                <option value="strawberries" selected>{{trans('product/details/details.size')}}</option>
                ...
                <div class="addto row">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <button onclick="productAddToCartForm.submit(this);"
                            ...
                            {{trans('product/details/details.add_to_cart')}}
                        </button>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12"><a class="link-wishlist wishlist btn-block ">{{trans('product/details/details.add_to_wishlist')}}</a></div>
                </div>
    ...
    <div class="row recommended">
        <h1> {{trans('product/details/details.you_may_also_like')}} </h1>

        <div id="SimilarProductSlider">
            <div class="item">
                <div class="product"><a class="product-image"> <img src="{{url('assets/frontend/images/product/a1.jpg')}}" alt="img"> </a>
            ...
            <div class="item">
                <div class="product"><a class="product-image"> <img src="{{url('assets/frontend/images/product/a4.jpg')}}" alt="img"> </a>
            ...
            <div class="item">
                <div class="product"><a class="product-image"> <img src="{{url('assets/frontend/images/product/30.jpg')}}" alt="img"> </a>
            ...
            <div class="item">
                <div class="product"><a class="product-image"> <img src="{{url('assets/frontend/images/product/a5.jpg')}}" alt="img"> </a>
            ...
            <div class="item">
                <div class="product"><a class="product-image"> <img src="{{url('assets/frontend/images/product/36.jpg')}}" alt="img"> </a>
            ...
            <div class="item">
                <div class="product"><a class="product-image"> <img src="{{url('assets/frontend/images/product/13.jpg')}}" alt="img"> </a>
