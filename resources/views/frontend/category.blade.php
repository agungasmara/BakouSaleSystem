    ...
    <div class="row">
        ...
        <div class="col-lg-9 col-md-9 col-sm-12">
            <div class="w100 clearfix category-top">
                ...
                <div class="categoryImage"><img src="{{url('assets/frontend/images/site/category.jpg')}}" class="img-responsive" alt="img"></div>
            </div>
            <!--/.category-top-->
            ...
            <div class="row subCategoryList clearfix">
                <div class="col-lg-2 col-md-2 col-sm-3 col-xs-4  text-center ">
                    <div class="thumbnail"><a class="subCategoryThumb" href="sub-category.html"><img
                            src="{{url('assets/frontend/images/product/3.jpg')}}" class="img-rounded " alt="img"> </a> <a class="subCategoryTitle"><span> T shirt </span></a>
                    </div>
                </div>
                <div class="col-lg-2 col-md-2 col-sm-3 col-xs-4  text-center">
                    <div class="thumbnail"><a class="subCategoryThumb" href="sub-category.html"><img
                            src="{{url('assets/frontend/images/site/casual.jpg')}}" class="img-rounded " alt="img"> </a> <a
                            class="subCategoryTitle"><span> Shirt </span></a></div>
                </div>
                <div class="col-lg-2 col-md-2 col-sm-3 col-xs-4  text-center">
                    <div class="thumbnail"><a class="subCategoryThumb" href="sub-category.html"><img
                            src="{{url('assets/frontend/images/site/shoe.jpg')}}" class="img-rounded " alt="img"> </a> <a class="subCategoryTitle"><span> shoes </span></a>
                    </div>
                </div>
                <div class="col-lg-2 col-md-2 col-sm-3 col-xs-4  text-center">
                    <div class="thumbnail"><a class="subCategoryThumb" href="sub-category.html"><img
                            src="{{url('assets/frontend/images/site/jewelry.jpg')}}" class="img-rounded " alt="img"> </a> <a
                            class="subCategoryTitle"><span> Accessories </span></a></div>
                </div>
                <div class="col-lg-2 col-md-2 col-sm-3 col-xs-4  text-center">
                    <div class="thumbnail"><a class="subCategoryThumb" href="sub-category.html"><img
                            src="{{url('assets/frontend/images/site/winter.jpg')}}" class="img-rounded  " alt="img"> </a> <a
                            class="subCategoryTitle"><span> Winter Collection </span></a></div>
                </div>
                <div class="col-lg-2 col-md-2 col-sm-3 col-xs-4  text-center">
                    <div class="thumbnail"><a class="subCategoryThumb" href="sub-category.html"><img
                            src="{{url('assets/frontend/images/site/Male-Fragrances.jpg')}}" class="img-rounded " alt="img"> </a> <a
                ...
                <div class="item col-sm-4 col-lg-4 col-md-4 col-xs-6">
                    <div class="product">
                        ...
                        <div class="image">
                            ...
                            <a href="product-details.html"><img src="{{url('assets/frontend/images/product/16.jpg')}}" alt="img"
                                                                class="img-responsive"></a></div>
                        <div class="description">
                ...
                <div class="item col-sm-4 col-lg-4 col-md-4 col-xs-6">
                    <div class="product">
                        ...
                        <div class="image">
                            ...
                            <a href="product-details.html"><img src="{{url('assets/frontend/images/product/19.jpg')}}" alt="img"
                                                                class="img-responsive"></a></div>
                        <div class="description">
