...
insert  into `sg_attribute`(`attribute_id`,`attribute_group_id`,`sort_order`) values (1,6,1),(2,6,5),(3,6,3),(4,3,1),(5,3,2),(6,3,3),(7,3,4),(8,3,5),(9,3,6),(10,3,7),(11,3,8);
...
insert  into `sg_attribute_description`(`attribute_id`,`language_id`,`name`) values (1,1,'Description'),(2,1,'No. of Cores'),(4,1,'test 1'),(5,1,'test 2'),(6,1,'test 3'),(7,1,'test 4'),(8,1,'test 5'),(9,1,'test 6'),(10,1,'test 7'),(11,1,'test 8'),(3,1,'Clockspeed');
...
insert  into `sg_category_to_store`(`category_id`,`store_id`) values (17,0),(18,0),(20,0),(24,0),(25,0),(26,0),(27,0),(28,0),(28,1),(29,0),(30,0),(31,0),(32,0),(33,0),(33,1),(34,0),(35,0),(36,0),(37,0),(38,0),(39,0),(40,0),(41,0),(42,0),(43,0),(44,0),(45,0),(46,0),(47,0),(48,0),(49,0),(50,0),(51,0),(52,0),(53,0),(54,0),(55,0),(56,0),(57,0),(58,0);
...
insert  into `sg_currency`(`currency_id`,`title`,`code`,`symbol_left`,`symbol_right`,`decimal_place`,`value`,`status`,`date_modified`) values (1,'Pound Sterling','GBP','£','','2',0.61250001,1,'2014-09-25 14:40:00'),(2,'US Dollar','USD','$','','2',1.00000000,1,'2017-11-20 07:31:04'),(3,'Euro','EUR','','€','2',0.78460002,1,'2014-09-25 14:40:00');
...
insert  into `sg_customer_group`(`customer_group_id`,`approval`,`sort_order`) values (1,0,1);
...
insert  into `sg_customer_group_description`(`customer_group_id`,`language_id`,`name`,`description`) values (1,1,'Default','test');
...
insert  into `sg_information`(`information_id`,`bottom`,`sort_order`,`status`) values (3,1,3,1),(4,1,1,1),(5,1,4,1),(6,1,2,1);
...
insert  into `sg_information_description`(`information_id`,`language_id`,`title`,`description`,`meta_title`,`meta_description`,`meta_keyword`) values (4,1,'About Us','&lt;p&gt;\r\n	About Us&lt;/p&gt;\r\n','About Us','',''),(5,1,'Terms &amp; Conditions','&lt;p&gt;\r\n	Terms &amp;amp; Conditions&lt;/p&gt;\r\n','Terms &amp; Conditions','',''),(3,1,'Privacy Policy','&lt;p&gt;\r\n	Privacy Policy&lt;/p&gt;\r\n','Privacy Policy','',''),(6,1,'Delivery Information','&lt;p&gt;\r\n	Delivery Information&lt;/p&gt;\r\n','Delivery Information','','');
...
insert  into `sg_information_to_store`(`information_id`,`store_id`) values (3,0),(4,0),(5,0),(6,0);
...
insert  into `sg_language`(`language_id`,`name`,`code`,`locale`,`image`,`directory`,`sort_order`,`status`) values (1,'English','en-gb','en-US,en_US.UTF-8,en_US,en-gb,english','gb.png','english',1,1);
...
insert  into `sg_manufacturer`(`manufacturer_id`,`name`,`image`,`sort_order`) values (5,'HTC','catalog/demo/htc_logo.jpg',0),(6,'Palm','catalog/demo/palm_logo.jpg',0),(7,'Hewlett-Packard','catalog/demo/hp_logo.jpg',0),(8,'Apple','catalog/demo/apple_logo.jpg',0),(9,'Canon','catalog/demo/canon_logo.jpg',0),(10,'Sony','catalog/demo/sony_logo.jpg',0);
...
insert  into `sg_option`(`option_id`,`type`,`sort_order`) values (1,'radio',1),(2,'checkbox',2),(4,'text',3),(5,'select',4),(6,'textarea',5),(7,'file',6),(8,'date',7),(9,'time',8),(10,'datetime',9),(11,'select',10),(12,'date',11);
...
insert  into `sg_option_description`(`option_id`,`language_id`,`name`) values (1,1,'Radio'),(2,1,'Checkbox'),(4,1,'Text'),(6,1,'Textarea'),(8,1,'Date'),(7,1,'File'),(5,1,'Select'),(9,1,'Time'),(10,1,'Date &amp; Time'),(12,1,'Delivery Date'),(11,1,'Size');
...
insert  into `sg_option_value`(`option_value_id`,`option_id`,`image`,`sort_order`) values (43,1,'',3),(32,1,'',1),(45,2,'',4),(44,2,'',3),(42,5,'',4),(41,5,'',3),(39,5,'',1),(40,5,'',2),(31,1,'',2),(23,2,'',1),(24,2,'',2),(46,11,'',1),(47,11,'',2),(48,11,'',3);
...
insert  into `sg_option_value_description`(`option_value_id`,`language_id`,`option_id`,`name`) values (43,1,1,'Large'),(32,1,1,'Small'),(45,1,2,'Checkbox 4'),(44,1,2,'Checkbox 3'),(31,1,1,'Medium'),(42,1,5,'Yellow'),(41,1,5,'Green'),(39,1,5,'Red'),(40,1,5,'Blue'),(23,1,2,'Checkbox 1'),(24,1,2,'Checkbox 2'),(48,1,11,'Large'),(47,1,11,'Medium'),(46,1,11,'Small');
...
insert  into `sg_order_status`(`order_status_id`,`language_id`,`name`) values (2,1,'Processing'),(3,1,'Shipped'),(7,1,'Canceled'),(5,1,'Complete'),(8,1,'Denied'),(9,1,'Canceled Reversal'),(10,1,'Failed'),(11,1,'Refunded'),(12,1,'Reversed'),(13,1,'Chargeback'),(1,1,'Pending'),(16,1,'Voided'),(15,1,'Processed'),(14,1,'Expired');
...
insert  into `sg_product_attribute`(`product_id`,`attribute_id`,`language_id`,`text`) values (43,2,1,'1'),(47,4,1,'16GB'),(43,4,1,'8gb'),(42,3,1,'100mhz'),(47,2,1,'4');
...
insert  into `sg_product_option`(`product_option_id`,`product_id`,`option_id`,`value`,`required`) values (224,35,11,'',1),(225,47,12,'2011-04-22',1),(221,42,9,'22:25',1),(223,42,2,'',1),(217,42,5,'',1),(209,42,6,'',1),(218,42,1,'',1),(208,42,4,'test',1),(226,30,5,'',1),(219,42,8,'2011-02-20',1),(222,42,7,'',1),(220,42,10,'2011-02-20 22:25',1);
...
insert  into `sg_product_related`(`product_id`,`related_id`) values (40,42),(41,42),(42,40),(42,41);
...
insert  into `sg_product_special`(`product_special_id`,`product_id`,`customer_group_id`,`priority`,`price`,`date_start`,`date_end`) values (441,42,1,1,'90.0000','0000-00-00','0000-00-00'),(439,30,1,2,'90.0000','0000-00-00','0000-00-00'),(438,30,1,1,'80.0000','0000-00-00','0000-00-00');
...
insert  into `sg_product_to_category`(`product_id`,`category_id`) values (28,20),(28,24),(29,20),(29,24),(30,20),(30,33),(31,33),(32,34),(33,20),(33,28),(34,34),(35,20),(36,34),(40,20),(40,24),(41,27),(42,20),(42,28),(43,18),(43,20),(44,18),(44,20),(45,18),(46,18),(46,20),(47,18),(47,20),(48,20),(48,34),(49,57);
...
insert  into `sg_product_to_layout`(`product_id`,`store_id`,`layout_id`) values (42,1,0),(42,0,0);
...
insert  into `sg_product_to_store`(`product_id`,`store_id`) values (28,0),(29,0),(30,0),(31,0),(32,0),(33,0),(34,0),(35,0),(36,0),(40,0),(41,0),(42,0),(42,1),(43,0),(44,0),(45,0),(46,0),(47,0),(48,0),(49,0);
...
insert  into `sg_session`(`session_id`,`data`,`expire`) values ('01301ff23b1fc7bc8b9cfe34e7','{\"language\":\"en-gb\",\"currency\":\"USD\",\"user_id\":\"1\",\"user_token\":\"vX2yZw7JISyHIem0iI5MIlCNNOUiP0V8\"}','2017-11-20 08:44:09');
...
insert  into `sg_stock_status`(`stock_status_id`,`language_id`,`name`) values (7,1,'In Stock'),(8,1,'Pre-Order');
...
insert  into `sg_store`(`store_id`,`name`,`url`,`ssl`,`owner_id`) values (1,'reseller1','http://test.localhost:81/openCart302/reseller1','',0);
...
insert  into `sg_tax_class`(`tax_class_id`,`title`,`description`,`date_added`,`date_modified`) values (9,'Taxable Goods','Taxed goods','2009-01-06 23:21:53','2011-09-23 14:07:50'),(10,'Downloadable Products','Downloadable','2011-09-21 22:19:39','2011-09-22 10:27:36');
...
insert  into `sg_tax_rate`(`tax_rate_id`,`geo_zone_id`,`name`,`rate`,`type`,`date_added`,`date_modified`) values (86,3,'VAT (20%)','20.0000','P','2011-03-09 21:17:10','2011-09-22 22:24:29'),(87,3,'Eco Tax (-2.00)','2.0000','F','2011-09-21 21:49:23','2011-09-23 00:40:19');
...
insert  into `sg_test`(`id`,`name`) values (1,'User'),(2,'Resource');
...
/*Table structure for table `sg_user` */
...
/*Data for the table `sg_user` */

insert  into `sg_user`(`user_id`,`user_group_id`,`username`,`password`,`salt`,`firstname`,`lastname`,`email`,`image`,`code`,`ip`,`status`,`date_added`) values (1,1,'admin','44070dd6d38aec2a57dd54170a53a6141d7cabc9','0Y3pe4Cx4','John','Doe','sreyleakyem@hotmail.com','','','127.0.0.1',1,'2017-11-20 14:03:44');
...
insert  into `sg_users`(`id`,`name`,`email`,`password`,`remember_token`,`created_at`,`updated_at`) values (1,'admin','admin@admin.com','$2y$10$flAZmP7ClUp0gG54aYNzNutHgSlMSLyACRg.NVtRpqDfjLouJICIy',NULL,NULL,NULL);
