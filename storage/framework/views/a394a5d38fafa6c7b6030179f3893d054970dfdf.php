    ...
    <div class="full-container">
        <div class="slider-content">
            ...
            <div class="slider slider-v1"
                ...
                <div class="slider-item slider-item-img1"><img src="<?php echo e(url('assets/frontend/images/slider/slider0.jpg')); ?>"
                ...
                <div class="slider-item slider-item-img1">
                    ...
                    <img src="<?php echo e(url('assets/frontend/images/slider/slider1.jpg')); ?>" class="img-responsive parallaximg sliderImg" alt="img"></div>
                <!--/.slider-item-->
                ...
                <div class="slider-item slider-item-img2 ">
                    ...
                    <img src="<?php echo e(url('assets/frontend/images/slider/slider3.jpg')); ?>" class="img-responsive parallaximg sliderImg" alt="img"></div>
                <!--/.slider-item-->
                            ...
                            <div class="col-lg-5 col-md-4 col-sm-6 col-xs-8   pull-left sliderText white hidden-xs">
                                <div class="inner">
                                    ...
                                    <p class="hidden-xs">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed
                                        ...
                                        volutpat. </p>
                                    <a href="category.html" class="btn btn-primary"><?php echo e(trans('product/home/home.shop_now')); ?><span class="arrowUnicode">►</span></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <img src="<?php echo e(url('assets/frontend/images/slider/slider4.jpg')); ?>" class="img-responsive parallaximg sliderImg" alt="img"></div>
                <!--/.slider-item-->
                ...
                <div class="slider-item slider-item-img3">
                    <div class="sliderInfo">
                        <div class="container">
                            <div class="col-lg-5 col-md-6 col-sm-5 col-xs-5 pull-left sliderText blankstyle transformRight">
                                <div class="inner text-right"><img src="<?php echo e(url('assets/frontend/images/slider/color.png')); ?>" class="img-responsive"
                                                                   alt="img"></div>
                            </div>
                    ...
                    <img src="<?php echo e(url('assets/frontend/images/slider/6.jpg')); ?>" class="img-responsive parallaximg sliderImg" alt="img"></div>
            </div>
            <!--/.slider slider-v1-->
        </div>
        <!--/.slider-content-->
