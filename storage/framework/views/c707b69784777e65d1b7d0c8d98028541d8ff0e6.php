...
<script src="<?php echo e(url('assets/frontend/js/select2.min.js')); ?>"></script>
...
<!-- Rating -->
<script type="text/javascript" src="<?php echo e(url('assets/frontend/plugins/rating/bootstrap-rating.min.js')); ?>"></script>
<script>
    $(function () {
