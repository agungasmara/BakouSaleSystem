        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-sm-6 col-xs-6 col-md-6">
                    <div class="pull-left ">
                        <ul class="userMenu ">
                            <li><a href="#"> <span class="hidden-xs"><?php echo e(trans('product/header/header.help')); ?></span><i
                ...
                <div class="col-lg-6 col-sm-6 col-xs-6 col-md-6 no-margin no-padding">
                    <div class="pull-right">
                        <ul class="userMenu">
                            <li><a href="<?php echo e(url('account')); ?>"><span class="hidden-xs"><?php echo e(trans('product/header/header.my_account')); ?></span> <i
                                    class="glyphicon glyphicon-user hide visible-xs "></i></a></li>
                            <li><a href="#" data-toggle="modal" data-target="#ModalLogin"> <span class="hidden-xs"><?php echo e(trans('product/header/header.sign_in')); ?></span>
                                <i class="glyphicon glyphicon-log-in hide visible-xs "></i> </a></li>
                            <li class="hidden-xs"><a href="#" data-toggle="modal" data-target="#ModalSignup"><?php echo e(trans('product/header/header.create_account')); ?></a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-cart"><i
                    ...
                    class="cartRespons colorWhite"><?php echo e(trans('product/header/header.cart')); ?> ($210.00) </span></button>
            <a class="navbar-brand " href="<?php echo e(url('/')); ?>"> <img src="<?php echo e(url('assets/frontend/images/logo.png')); ?>" alt="TSHOP"> </a>
        ...
        <div class="navbar-cart  collapse">
            <div class="cartMenu  col-lg-4 col-xs-12 col-md-4 ">
                    ...
                    <table>
                        ...
                        <tr class="miniCartProduct">
                            <td style="width:20%" class="miniCartProductThumb">
                                <div><a href="product-details.html"> <img src="<?php echo e(url('assets/frontend/images/product/3.jpg')); ?>" alt="img"> </a>
                                </div>
                            </td>
                            <td style="width:40%">
                        ...
                        <tr class="miniCartProduct">
                            <td style="width:20%" class="miniCartProductThumb">
                                <div><a href="product-details.html"> <img src="<?php echo e(url('assets/frontend/images/product/2.jpg')); ?>" alt="img"> </a>
                                </div>
                            </td>
                            <td style="width:40%">
                                <div class="miniCartDescription">
                        ...
                        <tr class="miniCartProduct">
                            <td style="width:20%" class="miniCartProductThumb">
                                <div><a href="product-details.html"> <img src="<?php echo e(url('assets/frontend/images/product/5.jpg')); ?>" alt="img"> </a>
                                </div>
                            </td>
                            <td style="width:40%">
                                <div class="miniCartDescription">
                        ...
                        <tr class="miniCartProduct">
                            <td style="width:20%" class="miniCartProductThumb">
                                <div><a href="product-details.html"> <img src="<?php echo e(url('assets/frontend/images/product/4.jpg')); ?>" alt="img"> </a>
                                </div>
                            </td>
                            <td style="width:40%">
                                <div class="miniCartDescription">
                ...
                <div class="miniCartFooter  miniCartFooterInMobile text-right">
                    ...
                    <a class="btn btn-sm btn-danger" href="<?php echo e(url('cart')); ?>"> <i class="fa fa-shopping-cart"> </i><?php echo e(trans('product/header/header.view_cart')); ?>

                    </a> <a href="checkout-0.html"
                            class="btn btn-sm btn-primary"> <?php echo e(trans('product/header/header.check_out')); ?> </a></div>
                <!--/.miniCartFooter-->
                    ...
                    <ul class="dropdown-menu">
                        <li class="megamenu-content ">
                            <ul class="col-lg-3  col-sm-3 col-md-3 unstyled noMarginLeft newCollectionUl">
                                ...
                                <li><a href="<?php echo e(url('product/category')); ?>"> ALL NEW PRODUCTS </a></li>
                                <li><a href="<?php echo e(url('product/category')); ?>"> NEW TOPS </a></li>
                                <li><a href="<?php echo e(url('product/category')); ?>"> NEW SHOES </a></li>
                                <li><a href="<?php echo e(url('product/category')); ?>"> NEW TSHIRT </a></li>
                                <li><a href="<?php echo e(url('product/category')); ?>"> NEW TSHOP </a></li>
                            </ul>
                            <ul class="col-lg-3  col-sm-3 col-md-3  col-xs-4">
                                <li><a class="newProductMenuBlock" href="product-details.html"> <img
                                        class="img-responsive" src="<?php echo e(url('assets/frontend/images/site/promo1.jpg')); ?>" alt="product"> <span
                                        class="ProductMenuCaption"> <i class="fa fa-caret-right"> </i> JEANS </span>
                                </a></li>
                            </ul>
                            <ul class="col-lg-3  col-sm-3 col-md-3 col-xs-4">
                                <li><a class="newProductMenuBlock" href="product-details.html"> <img
                                        class="img-responsive" src="<?php echo e(url('assets/frontend/images/site/promo2.jpg')); ?>" alt="product"> <span
                                        class="ProductMenuCaption"> <i
                                        class="fa fa-caret-right"> </i> PARTY DRESS </span> </a></li>
                            </ul>
                            <ul class="col-lg-3  col-sm-3 col-md-3 col-xs-4">
                                <li><a class="newProductMenuBlock" href="product-details.html"> <img
                                        class="img-responsive" src="<?php echo e(url('assets/frontend/images/site/promo3.jpg')); ?>" alt="product"> <span
                    ...
                    <ul class="dropdown-menu">
                        <li class="megamenu-content">
                            ...
                            <ul class="col-lg-3  col-sm-3 col-md-3 col-xs-6">
                                <li class="no-margin productPopItem "><a href="<?php echo e(url('product/detail')); ?>"> <img
                                        class="img-responsive" src="<?php echo e(url('assets/frontend/images/site/g4.jpg')); ?>" alt="img"> </a> <a
                                        class="text-center productInfo alpha90" href="<?php echo e(url('product/detail')); ?>"> Eodem modo
                                    typi <br>
                                    <span> $60 </span> </a></li>
                            </ul>
                            <ul class="col-lg-3  col-sm-3 col-md-3 col-xs-6">
                                <li class="no-margin productPopItem relative"><a href="<?php echo e(url('product/detail')); ?>"> <img
                                        class="img-responsive" src="<?php echo e(url('assets/frontend/images/site/g5.jpg')); ?>" alt="img"> </a> <a
                                        class="text-center productInfo alpha90" href="<?php echo e(url('product/detail')); ?>"> Eodem modo
                                    typi <br>
                                    <span> $60 </span> </a></li>
                            </ul>
                    ...
                    <div class="dropdown-menu col-lg-4 col-xs-12 col-md-4 ">
                        <div class="w100 miniCartTable scroll-pane">
                            <table>
                                ...
                                <tr class="miniCartProduct">
                                    <td style="width:20%" class="miniCartProductThumb">
                                        <div><a href="product-details.html"> <img src="<?php echo e(url('assets/frontend/images/product/3.jpg')); ?>" alt="img">
                                        </a></div>
                                    </td>
                                    <td style="width:40%">
                                        <div class="miniCartDescription">
                                ...
                                <tr class="miniCartProduct">
                                    <td style="width:20%" class="miniCartProductThumb">
                                        <div><a href="product-details.html"> <img src="<?php echo e(url('assets/frontend/images/product/2.jpg')); ?>" alt="img">
                                        </a></div>
                                    </td>
                                    <td style="width:40%">
                                        <div class="miniCartDescription">
                                ...
                                <tr class="miniCartProduct">
                                    <td style="width:20%" class="miniCartProductThumb">
                                        <div><a href="product-details.html"> <img src="<?php echo e(url('assets/frontend/images/product/5.jpg')); ?>" alt="img">
                                        </a></div>
                                    </td>
                                    <td style="width:40%">
                                        <div class="miniCartDescription">
                                ...
                                <tr class="miniCartProduct">
                                    <td style="width:20%" class="miniCartProductThumb">
                                        <div><a href="product-details.html"> <img src="<?php echo e(url('assets/frontend/images/product/4.jpg')); ?>" alt="img">
                                        </a></div>
                                    </td>
                                    <td style="width:40%">
                                        <div class="miniCartDescription">
                                ...
                                <tr class="miniCartProduct">
                                    <td style="width:20%" class="miniCartProductThumb">
                                        <div><a href="product-details.html"> <img src="<?php echo e(url('assets/frontend/images/site/winter.jpg')); ?>"
                                                                                  alt="img"> </a></div>
                                    </td>
                                    <td style="width:40%">
                                        <div class="miniCartDescription">
                        ...
                        <div class="miniCartFooter text-right">
                            <h3 class="text-right subtotal"> Subtotal: $210 </h3>
                            <a class="btn btn-sm btn-danger" href="<?php echo e(url('cart')); ?>"> <i class="fa fa-shopping-cart"> </i> VIEW
                                CART </a><a
